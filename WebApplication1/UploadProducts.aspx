        ...
        <table style="width:100%; background-color:#FAFAFA">
            ...
            <tr>
                ...
                <td class="auto-style37" colspan="2">
                    ...
                    <asp:Button ID="btnUpload" class="buttonDesign buttonUpload buttonUpload:hover" runat="server" OnClick="btnUpload_Click" Text="Upload" OnClientClick="javascript:alert('Uploaded Successfully')"/>
                </td>
            </tr>
            <tr>
